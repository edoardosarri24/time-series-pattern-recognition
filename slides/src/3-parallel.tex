...
\begin{frame}{Parallel}
        ...
        \begin{enumerate}
            \item \textbf{Input Loading:} Caricamento \href{https://github.com/edoardosarri24/time-series-pattern-recognition/blob/ad87a0253ee835e58eb0952dae458c5aa90ee3a1/parallel/src/data_loader.cpp}{dati} e \href{https://github.com/edoardosarri24/time-series-pattern-recognition/blob/a9dfa266d9fea1eae1e7256da641cce54909b2f5/parallel/src/query_loader.cpp}{query}. Come nella versione sequenziale, ma in più si una pinned memory.
            \item \textbf{Trasferimento H2D:} Si carica in GPU i dati grezzi.
            \item \textbf{Kernel:} Ogni thread \href{https://github.com/edoardosarri24/time-series-pattern-recognition/blob/af609693f2d00e4c02d028b127c87bc5454f72d8/parallel/src/kernel.cu}{calcola} la SAD per un timestamp.
    ...
    \begin{block}{Grid}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item Usando la riduzione locale al blocco, le scritture in global memory sono ridotte del $1-\tfrac{1}{M}\approx99.6\%$.
