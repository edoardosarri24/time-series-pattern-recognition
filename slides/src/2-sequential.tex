...
\begin{frame}{Sequential}
    \begin{block}{Data Loading}
        Il file di input può raggiungere grandi dimensioni ($\approx 3.5$ GB per gli esperimenti).
        \begin{itemize}
...
\begin{frame}{Sequential}
    \begin{block}{Memory Layout}
        ...
        \begin{itemize}
            ...
            \item \textbf{Vettorializzazione:} Compiling con flag \texttt{-march=native} e keyword \texttt{restrict} per permettere eliminare ambiguità al compilatore.
            \item \textbf{Padding:} Allineamento dei dati a multipli di 64 Byte:
            \begin{itemize}
                \item 6 float per timestamp $\Rightarrow$ 24 Byte.
                \item Aggiunti 2 float fittizi per raggiungere 32 Byte per timestamp.
            \end{itemize}
        \end{itemize}
    \end{block}
\end{frame}
